...
├── CivicLedger-cli/            # Command-line interface
│   └── src/               # CLI implementation
└── CivicLedger-ui/             # Web browser interface
...
```
> compact
> compact compile src/CivicLedger.compact ./src/managed/CivicLedger
...
> build
> rm -rf dist && tsc --project tsconfig.build.json && cp -Rf ./src/managed ./dist/managed && cp ./src/CivicLedger.compact ./dist
...
- [Midnight Documentation](https://docs.midnight.network/examples/dapps/CivicLedger) - Complete developer guide
